...
function madlibMakerRun() {
    ...
    madlibMakerParagraph.innerHTML = `It was three days ago when I went to the ${noun}. While there I ${verb} in the most ${adjective} manner. I think I'll do that again ${adverb}.`;
}
